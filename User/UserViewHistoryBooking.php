      ...
      <div style="overflow-x:auto;">
        ...
        <div class="adminSchedule">
          ...
          <table>
            ...
            <?php
            $currentDate = date('Y-m-d'); // generate today's date
            $user_Id = isset($_SESSION['u_ID']) ? $_SESSION['u_ID'] : null;
            if ($user_Id !== null) {
              $sql = "SELECT * FROM booking WHERE Departure_Date <= '$currentDate' AND User_ID = '$user_Id'"; // select past bookings
            ...
            <tr>
              ...
              <td>
                <a href="UserViewHistoryBooking.php?cancel_bookingId=<?php echo $row["Reservation_ID"]?>"><button class="button1"><b>Cancel</b></button></a> 
              </td>   
            </tr>
            <?php
                }
